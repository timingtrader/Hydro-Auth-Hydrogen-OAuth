...
const baseUrl = ''; //baseUrl for Hydro API
...
const oauthBaseUrl = ''; //baseurl for oauth API
const authPartnerUsername = ''; //(plug in your own)
const authPartnerKey = ''; //(plug in your own)
